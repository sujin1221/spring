...
public class ServletConfiguraion implements WebMvcConfigurer {
	...
	//multipartResolver 설정 => 반드시 bean 이름이 mutipartResolver이어야만 함!
	//(name="multipartResolver") => 꼭 이름 지정해줘야함!
